...
function Project() {
    ...
    <div className="projects-container" id="projects">
        <h1 className="hero-title">Personal Projects</h1>
        <div className="projects-grid">
            <div className="project">
                ...
                <a href="https://www.therakyatpost.com/fun/2024/12/20/come-and-play-ddakji-squid-game-takes-over-mrt-ampang-park/" target="_blank" rel="noreferrer"><h2 className="hero-title">Netflix's Squid Game 2 Poll System</h2></a>
