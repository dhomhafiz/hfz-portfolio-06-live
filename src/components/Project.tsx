    ...
    <div className="projects-container" id="projects">
        ...
        <div className="projects-grid">
            <div className="project">
                ...
                <a href="https://www.therakyatpost.com/fun/2024/12/20/come-and-play-ddakji-squid-game-takes-over-mrt-ampang-park/" target="_blank" rel="noreferrer"><h2>Netflix's Squid Game Poll System</h2></a>
                <p>Built the Netflix Squid Game interactive poll system as featured in the series using Python as part of Netflix's promotion of the series at MRT Station Ampang Park, KL, Malaysia.</p>
