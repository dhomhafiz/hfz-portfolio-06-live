...
function Footer() {
  return (
    <footer>
      ...
      <p>A portfolio designed & built by <a href="https://github.com/yujisatojr/react-portfolio-template" target="_blank" rel="noreferrer">Mohd Hafiz Abd Rahim</a> with 💜</p>
    </footer>
  );
}
