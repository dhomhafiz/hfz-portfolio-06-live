...
function Footer() {
  return (
    <footer>
      ...
      <p>A portfolio designed & built by <a href="https://github.com/dhomhafiz/hfz-portfolio-06-live.git" target="_blank" rel="noreferrer">Mohd Hafiz Abd Rahim</a> with 💜</p>
    </footer>
  );
}
